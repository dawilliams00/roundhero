...
CLASSES = {
    ...
    "Sorcerer": {
        ...
        "features": {
            ...
            2:  [{"name": "Font of Magic", "max": 0, "rest_type": "long", "action": "Passive", "description": "Sorcery Points = sorcerer level. Convert to spell slots or use for Metamagic."},
                 {"name": "Flexible Casting", "max": 0, "rest_type": "long", "action": "Passive", "description": "Convert spell slots to sorcery points and vice versa."}],
